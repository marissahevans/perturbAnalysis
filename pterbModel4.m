function [lsTot, AS, fb, ASsem, fbSem] = pterbModel4(feedbackErrmean,confmean,numTrial,numSims,r,ptb,arcSize,sigma_m,sigma_p,alpha_m,alpha_p,sigma_aim,alpha_mf)
