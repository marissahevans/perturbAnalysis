...
for ss = 1:length(subjAll)
    ...
    cvAll(ss,:) = [mean(cvLS1) mean(cvLS2) mean(cvLS3) mean(cvLS4)];
    ...
    filename2 = sprintf('%s_fMinOutput.mat',subj);
    save(fullfile(path,filename2), 'var1', 'var2','var3','var4','lsAll','lsDiff','cvLS1','cvLS2','cvLS3','cvLS4','AS1','AS2','AS3','AS4','ASsem1','ASsem2',...
        'ASsem3','ASsem4','fb1','fb2','fb3','fb4','fbSem1','fbSem2','fbSem3','fbSem4','feedbackErrmean','confmean')
